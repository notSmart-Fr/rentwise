          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4 mt-2">
              {['twitter', 'instagram', 'linkedin'].map(social => (
                <button key={social} className="w-10 h-10 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center text-text-muted hover:text-white hover:bg-primary/20 hover:border-primary/20 transition-all active:scale-90 capitalize text-[10px] font-bold">
                  {social[0]}
                </button>
              ))}
            </div>

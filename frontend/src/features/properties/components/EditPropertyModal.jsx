...
const EditPropertyModal = ({ isOpen, onClose, onSuccess, property }) => {
  ...
  return (
    <div className="fixed inset-0 z-1000 flex justify-center overflow-y-auto bg-bg-base/95 px-6 pb-12 pt-32 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-white/5 bg-white/5 p-8 shadow-2xl backdrop-blur-xl sm:p-10 animate-zoom-in">
        {/* Header */}
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-2 sm:col-span-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                className="w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-xs text-white transition-all focus:border-primary focus:bg-white/10 focus:outline-none font-mono"
              ></textarea>
            </div>
          </div>
